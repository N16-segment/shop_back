...
public class TestController {
  ...
  //평소랑 다르게 데이터를 전달받아야 한다.
  //DTO 객체로 전달된 데이터(문자, 숫자)를 받되, @RequestBody 어노테이션은 사용하지 않는다.
  //그렇다고 해서 DTO 객체로 첨부파일 정보를 받는 것은 아니다.
  //그러나, 첨부파일 데이터를 받으려면 -MultiPartFile 객체를 사용한다.
  //첨부파일 연습 1
  @PostMapping("/upload1")
